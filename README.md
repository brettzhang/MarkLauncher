...
- 🗂️ **文件夹导航** - 左侧 Chrome 书签栏/其他书签分类导航，点击分组后右侧仅显示当前分组，`All` 显示全部
...
1. **文件夹导航** - 点击左侧 `All` 查看全部书签，点击具体分组时右侧详情列表仅显示该分组内容
2. **书签打开** - 点击书签卡片在当前标签页打开
3. **新标签页打开** - `Ctrl` / `Cmd` + 点击书签，或右键选择“新标签页打开”
4. **复制链接** - 右键点击书签，选择“复制链接”
5. **双模式搜索** - 在顶部搜索框输入关键词进行书签搜索，Tab 键切换到网络搜索；书签搜索会遵循当前分组范围
6. **二维码生成** - 右键点击书签选择生成二维码
7. **主题切换** - 在设置中切换明暗主题
8. **置顶书签** - 右键点击书签选择置顶，常用书签会显示在顶部快捷区
